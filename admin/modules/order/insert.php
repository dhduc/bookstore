...
<?php
  ...
  if(isset($_POST['insert'])){
    ...
    $sql = "
      INSERT INTO post(name, thumb, author, category, price, pages, info, times, status) 
      VALUES ('$name', '$thumb', '$author', '$cat', '$price', '$page', '$info', '$time', '$status')
    ";
    mysql_query($sql);
  ...
  <tr>
    ...
    <td width="295" valign="top"><p>Tác giả:</p>
      ...
      <p>
        ...
        <input type="text" name="price" id="price" placeholder="Nhập giá sản phẩm" required="required" />
      </p>
      <p>Số trang:</p>
      <p>
        <label for="page"></label>
        <input type="text" name="page" id="page" placeholder="Nhập số trang"/ required="required">
      </p>
